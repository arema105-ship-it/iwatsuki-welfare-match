  ...
  return (
    <section className="tab-panel brand-panel">
      <div className="brand-atmosphere" aria-hidden="true">
        <span className="brand-glow brand-glow-tl" />
        <span className="brand-glow brand-glow-br" />
        <Compass className="brand-watermark brand-watermark-tr" strokeWidth={0.75} />
        <Compass className="brand-watermark brand-watermark-bl" strokeWidth={0.7} />
      </div>
